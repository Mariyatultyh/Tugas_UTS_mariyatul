...
<body style="background-image: url('https://img.freepik.com/free-vector/abstract-digital-science-fiction-matrix-like-background_587448-971.jpg?size=626&ext=jpg&ga=GA1.2.833843270.1668478839&semt=sph'); background-repeat: no-repeat; background-size: cover;">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="overflow: hidden;">
                                <img src="gambar/maharani.jpeg" alt="" style="height: 600px;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                ...
                                WHERE username='$user' AND password='$pass'")
                                    ...
                                    ?>
                                        ...
                                        <form class="user" method="POST" action="">
                                            ...
                                            <br>
                                            <a href="index.php">
                                                <input value="Back" class="btn btn-primary btn-user btn-block">
                                            </a>
                                        </form>
                                    <?php } ?>
                                    <hr>
