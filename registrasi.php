    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block " style="overflow: hidden; height: 820px; object-fit: cover;"> <img src="gambar/komputer.jpeg"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="post" action="simpan_pendaftaran.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label>NIM</label>
                                        <input type="text" class="form-control form-control-user" placeholder="NIM" name="nim"required>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Nama</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label>No. HP</label>
                                        <input type="text" class="form-control form-control-user" placeholder="No. HP" name="no_hp"required>
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Email</label>
                                ...
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="textarea" placeholder="Alamat" name="alamat"required class="form-control">
                                </div>
